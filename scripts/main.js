(function () {
    ...
    app = function ($, cyan) {
        cyan.pop("msg");
        if ($(".sld")[0]) {
            cyan.cssLoaded("./css/zslide.css", function () {
                require(['zslide'], function (zslide) {
        ...
        if ($(".sldflash")[0]) {
            cyan.cssLoaded("./css/zsldflash.css", function () {
                require(['zsldflash'], function (zsldflash) {
        ...
        if ($(".sldflash")[0]) {
            cyan.cssLoaded("./css/zdashboard.css", function () {
                require(['zdashboard'], function (zdashboard) {
                    zdashboard();
                });
            });
        }
        if ($(".mkr")[0]) {
            cyan.cssLoaded("./css/zmarker.css", function () {
                cyan.cssLoaded("./css/zvtimeline.css", function () {
                    require(['zmarker', 'zvtimeline'], function (zmarker, zvtimeline) {
        ...
        if ($(".tl-a")[0]) {
            cyan.cssLoaded("./css/ztimeline.css", function () {
                require(['ztimeline'], function (ztimeline) {
        ...
        if ($(".ztree")[0]) {
            cyan.cssLoaded("./css/ztree.css", function () {
    ...
    require(['jquery', 'cyan'], function ($, cyan) {
        $.noConflict(true);
        app($, cyan);
    });
}());
